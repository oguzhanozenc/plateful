import { Home, Box, Calendar, ClipboardList, Plus, Settings, } from "lucide-react";
    ...
    return (<Sidebar collapsible="icon">
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton asChild>
              <Link to="/" className="flex items-center hover-text-[#3c692c] transition-colors">
                <PIcon />
                <span>Plateful</span>
              </Link>
            </SidebarMenuButton>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {menuItems.map((item) => (<SidebarMenuItem key={item.title}>
                  <SidebarMenuButton asChild>
                    <Link to={item.route} className="flex items-center text-[#2D3E3A] hover:text-[#14250e] transition-colors">
      ...
      <SidebarFooter>
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton asChild>
              <Link to="/settings" className="flex items-center text-[#2a4621] hover:text-[#14250e] transition-colors">
